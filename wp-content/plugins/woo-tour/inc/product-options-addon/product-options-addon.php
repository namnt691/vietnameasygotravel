...
class EX_Woo_Custom_Option{
	...
	function frontend_scripts(){
		wp_enqueue_script( 'ex-woo-options',plugins_url('/js/options-addon.js', __FILE__) , array( 'jquery' ),'1.6' );
	}
	function frontend_style(){
		wp_enqueue_style('ex-woo-options', EX_WOO_OPTION_PATH.'css/style.css','1.6');
		if(is_rtl()){
			wp_enqueue_style('ex-woo-options-rtl', EX_WOO_OPTION_PATH.'css/rtl.css');
		}
	}
