		...
		<tbody>
			...
			<tr>
				<td colspan="6" class="actions clear">
					...
					<button type="submit" class="button primary mt-0 pull-left small update-cart" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
...
<div class="cart-collaterals large-5 col pb-0">
	...
	<div class="cart-sidebar col-inner <?php echo $sidebar_classes; ?>">
		...
		<form class="checkout_coupon mb-0" method="post" style='display:none!important'>
			<div class="coupon">
